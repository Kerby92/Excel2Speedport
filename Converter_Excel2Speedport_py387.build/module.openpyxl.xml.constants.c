...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "openpyxl.xml.constants", 155);
...
void checkModuleConstants_openpyxl$xml$constants(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "openpyxl.xml.constants", 155);
}
#endif
...
NUITKA_MAY_BE_UNUSED static char const *module_full_name = "openpyxl.xml.constants";
...
PyObject *modulecode_openpyxl$xml$constants(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    ...
    if (_init_done) {
#ifdef _NUITKA_TRACE
        PRINT_STRING("openpyxl.xml.constants: Skipping module init, already done.\n");
#endif
