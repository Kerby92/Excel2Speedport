...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "openpyxl.styles.builtins", 168);
...
void checkModuleConstants_openpyxl$styles$builtins(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "openpyxl.styles.builtins", 168);
}
#endif
...
NUITKA_MAY_BE_UNUSED static char const *module_full_name = "openpyxl.styles.builtins";
...
PyObject *modulecode_openpyxl$styles$builtins(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    ...
    if (_init_done) {
#ifdef _NUITKA_TRACE
        PRINT_STRING("openpyxl.styles.builtins: Skipping module init, already done.\n");
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        tmp_globals_name_1 = (PyObject *)moduledict_openpyxl$styles$builtins;
    ...
    }
    {
        ...
        tmp_globals_name_2 = (PyObject *)moduledict_openpyxl$styles$builtins;
